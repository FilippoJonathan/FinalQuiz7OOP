...
class siswa extends orang{
	...
	siswa(String name, String dob, int Sid){
		this.poin = 0;
		super(name,dob);
		this.Sid = Sid;
...
class Doseng extends orang{
	int codeDosen;
	
	Doseng(String name, String dob, int codeDosen){
		super(name,dob);
...
public class main {
	...
	public static void main(String[] args) {
		...
		case "Mahasiswa" :
			...
			siswa b =  new siswa(sc.nextLine(),sc.nextLine(),sc.nextInt());
			b.helpDosen();
			b.viewMahasiswa();
		case "Dosen" :
			System.out.println("input name , dob, and code dosen: ");
			Doseng c =  new Doseng(sc.nextLine(),sc.nextLine(),sc.nextInt());
			c.selfDev();
			c.teach();
			c.p2m();
			c.research();
